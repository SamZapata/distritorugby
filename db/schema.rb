...
ActiveRecord::Schema[7.0].define(version: 2021_04_11_234600) do
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.string "last_name"
    t.text "about"
    t.datetime "bithday", precision: nil
  ...
  create_table "tags_tournament_joins", force: :cascade do |t|
    ...
    t.bigint "tags_tournament_id"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["game_tournament_id"], name: "index_tags_tournament_joins_on_game_tournament_id"
    t.index ["tags_tournament_id"], name: "index_tags_tournament_joins_on_tags_tournament_id"
  end
